...
//     // make ioctl
//     if (ioctl(query_fd, QUERY_SET_VARIABLES, &q) == -1) {
//         printf("error in getting vAddr");
//     } else {
//         printf("migration: " + &rb + " addr:" + q.pfn);
//     }


//     // int pfn_now = (uintmax_t)entry.pfn;
//     int pfn_now = (uintmax_t)q.pfn;
...
static Property migration_properties[] = {
    ...
    DEFINE_PROP_MIG_CAP("x-bypass-shared-memory", MIGRATION_CAPABILITY_BYPASS_SHARED_MEMORY),
